...
public class BOJ17780 {
    ...
    /*
        ...
        - 맵의 색깔만 나타내는 map[][]를 하나 생성
        - state는 N*N의 LinkedList로 horse의 위아래 순서 상태 정보를 들고 있음
            - 이동 전에 본인이 젤 아래층 horse인지 체크
            - 뒤집을 때도 필요
        - horse만 묶은 배열을 하나 만들어서 현재 x,y,방향

        => 즉, 필요하다면 데이터가 중복되더라도 용도에 따라 다양한 자료구조 사용한다.
